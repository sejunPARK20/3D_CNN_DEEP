...
output_dir = os.path.join(script_dir, 'data', 'test_data')  # data/test_data 폴더 경로 생성
...
# 파일 경로 설정
video_d = os.path.join(output_dir, f'{data_num}_depth_test.mkv')
video_ir_path = os.path.join(output_dir, f'{data_num}_ir_test.mp4')
video_rgb_path = os.path.join(output_dir, f'{data_num}_rgb_test.mp4')
ppg_file_path = os.path.join(output_dir, f'{data_num}_ppg_test.txt')
time_file_path = os.path.join(output_dir, f'{data_num}_time_test.txt')
